...
public class VKGroupMessage {
    ...
    @Expose
    private List<Object> fwdMessages = new ArrayList<Object>();
     ...
     * @param out
     */
    public VKGroupMessage(Integer date, Integer from_id, Integer id, Integer out, Integer peer_id, String text, Integer conversationMessageId, List<Object> fwdMessages, Boolean important, Integer random_id, List<Object> attachments, Boolean is_hidden) {
        super();
        this.date = date;
